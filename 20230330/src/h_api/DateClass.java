...
public class DateClass {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat sdf2 = new SimpleDateFormat("HH:mm:ss.SSS");  //대문자 H는 24시간을 기준으로 한다. 대문자 SSS는 1/1000초 (밀리세컨즈)를 나타낸다.
		...
		Calendar cal = Calendar.getInstance(); 	//객체 생성 안해도됨. 싱글톤 패턴.  추상클래스는 생성자를 생성할 수 없다.
...
//		cal.set(2022, 2, 19); //월은 0부터 시작
		...
		int week_count = cal.getActualMaximum(Calendar.WEEK_OF_MONTH); //이번달 몇 주로 이루어져 있냐
		int day_count = cal.getActualMaximum(Calendar.DAY_OF_MONTH); 
		System.out.println(day);
		System.out.println("이번달은 " + week_count + "주로 되어있습니다.");
		System.out.println("이번달은 " + day_count + "일로 되어있습니다.");
