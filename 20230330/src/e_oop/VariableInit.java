...
public class VariableInit {
	...
	VariableInit() {
		var = 50;
//		staticVar = 60;
		//값을 공유해야 하는 클래스 변수가 객체생성 시마다 계속 초기화되기 떄문에 클래스 변수를 생성자에서 초기화 하는 것은 좋지 않다.
...
class Init{
	...
	Init(int a, int b, int c){
		this.a = a; //전역변수를 사용하기 위해 this를 쓴다. 변수의 이름이 같을 때 구분하기 위해 사용한다.
		this.b = b; //this는 클래스에 있는 객체의 주소를 저장하고 있는 하나의 변수
		this.c = c; //파란색 c는 클래스의 변수, 갈색 c는 파라미터 변수
...
//		c = 30;
		this(10, 20, 30);
		//this(): 생성자에서 다른 생성자를 호출할 때 사용한다. 맨 윗줄에 써야함.
	}
