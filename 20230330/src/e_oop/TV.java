...
public class TV {
	...
	static boolean power; //전원 : 켰다, 껐다.
	int channel;   //채널 : 직접 숫자 누르는 방법, 채널버튼으로 올리고 내리는 방법
	int volume;    //음량 : 음량 올리는 방법, 내리는 방법
	static String what;
	...
	void channelDirect() {
		System.out.println(what + "번 채널입니다.");
	...
	public static void main(String[] args) {
		...
		System.out.println("전원 켜기 : on / 전원 끄기 : off / 채널 변경 : 숫자입력  or chup or chdown / 볼륨 변경 : volup or voldown");
