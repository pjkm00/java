...
public class SampleClass {
	...
	public static void main(String[] args) {
		int local = 10; //지역변수 : 메서드 안에서만 사용가능한 변수
	}

	int field; 	//전역변수이면서 인스턴스 변수 : 클래스 전체 영역에서 사용하는 변수
			   	//초기화를 하기 않아도 사용할 수 있다.
			   	//초기화를 해주지 않으면 기본값으로 초기화된다. 
	...
	String method2(int parameter) { //리턴타입과 파라미터는 있을수도 없을수도 있다.
	...
	void flowTest1() {
		...
		flowTest3(); //같은 클래스의 메서드를 호출할때는 이렇게 호출한다.
